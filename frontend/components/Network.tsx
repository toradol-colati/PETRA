              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border border-carbon/15">
                {dict.partners.map((card, i) => (
                  <Link
                    ...
                    className={`block p-12 bg-ivory hover:bg-white transition-all duration-500 group cursor-pointer ${
                      i === 0
                  ...
                  >
                    ...
                    <span className="font-body text-xs font-bold uppercase text-crimson flex items-center gap-3 group-hover:gap-5 transition-all duration-500">
                      {card.link} <span>→</span>
                    </span>
                  </Link>
                ))}
